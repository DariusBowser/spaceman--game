...
## Overview
The objective of Spaceman is to guess the secret word before the spaceman appears to give up. The player has a limited amount of lives(guesses) to select the letters to guess the word. The player wins if the word is fully guessed before the lives run out.
